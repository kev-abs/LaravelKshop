                            ...
                            @forelse($Pedidos as $p)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <!-- ELIMINAR PEDIDO -->
                                        <form id="formEliminarPedido{{ $p['id_Pedido'] }}" 
                                            action="{{ route('pedidos.destroy', $p['id_Pedido']) }}" 
                                            method="POST" 
                                            class="d-inline">
                                            @csrf
                                            @method('DELETE')
                                            ...
                                            <button type="button" class="btn btn-outline-danger btn-sm btn-action" 
                                                    ...
                                                    data-bs-target="#confirmEliminarPedido{{ $p['id_Pedido'] }}">
                                                <i class="bi bi-trash3"></i>
                                            </button>
                                        </form>

                                        <!-- Modal de confirmación -->
                                        <div class="modal fade" id="confirmEliminarPedido{{ $p['id_Pedido'] }}" tabindex="-1" 
                                            aria-labelledby="confirmEliminarPedidoLabel{{ $p['id_Pedido'] }}" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="confirmEliminarPedidoLabel{{ $p['id_Pedido'] }}">Confirmar eliminación</h5>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" class="btn btn-danger" 
                                                        onclick="document.getElementById('formEliminarPedido{{ $p['id_Pedido'] }}').submit();">
                                                    Eliminar
                                                </button>
                                            </div>
                                            </div>
